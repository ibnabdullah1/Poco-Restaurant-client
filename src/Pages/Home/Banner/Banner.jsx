...
import img4 from "../../../assets/home/h2_shape-4.png";
import img5 from "../../../assets/home/h2_shape-5.png";
const Banner = () => {
  return (
    <div className="banner  px-10 pb-20 pt-36   md:pb-20 md:pt-36">
      <div className="  relative max-w-7xl mx-auto lg:flex justify-between items-center ">
        <div
          ...
          className="space-y-3 "
        >
          <h2 className="uppercase font-bold text-4xl z-30 text-center lg:text-left md:text-6xl text-white">
            UNLIMITED <br /> MEDIUM{" "}
        ...
        >
          <img className="w-[500px] z-20" src={banner} alt="" />
        </div>
        <img
